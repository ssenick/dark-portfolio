...
export function stickyBlock() {
    ...
    if (stickyParents.length) {
      stickyParents.forEach((stickyParent) => {
        let stickyConfig = {
          ...
          mobile: stickyParent.dataset.stickyMobile ? parseInt(stickyParent.dataset.stickyMobile) : null,
          rightPosition: stickyParent.dataset.rightPosition ? parseInt(stickyParent.dataset.rightPosition) : null,
  ...
  function stickyBlockItem(stickyParent, stickyConfig) {
    ...
    function stickyBlockActions(e) {
      ...
      if (stickyConfig.mobile && stickyConfig.mobile >= window.innerWidth) {
        stickyItemValues = {
          position: 'relative',
          bottom: 'auto',
          top: '0px',
